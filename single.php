					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<div class="clearfix row">
							<div class="col-sm-2 btnnav">
								<?php
									if ( get_previous_post() ) {
										echo '<a href="' . get_permalink(get_previous_post()->ID) . '" class="btn btn-primary btn-medium"><span class="glyphicon glyphicon-hand-left" aria-hidden="true"></span> Previous ' . dailyblank_option('dailykind') . '</a>';
									}
								?>
							</div>
							...
							<div class="col-sm-2 btnnav">
								<?php
									if (get_next_post()) {
										echo '<a href="' . get_permalink(get_next_post()->ID) . '" class="btn btn-primary btn-medium nav-right">Next ' . dailyblank_option('dailykind') . ' <span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span> </a>';
									}
								?>
							</div>
						</div>
