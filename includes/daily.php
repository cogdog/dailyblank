...
// update a post using the provided type and tag
	...
	// Update post content with templates for each TDC type
  	...
  	$dailyblank_post['post_content'] .= '<p class="tweet-deets">Tweet your response to <a href="https://twitter.com/' . dailyblank_option('twitteraccount') . '">@' . dailyblank_option('twitteraccount') . '</a> and be sure to include the hashtag <a href="https://twitter.com/search?q=%23' . $dailyblank_tag .'&f=live">#' . $dailyblank_tag . '</a></p>';
