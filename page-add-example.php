      	...
      	<?php if (!$post_id and !$must_login) : //hide form if we had success ?>
				...
				<?php else:?>
						...
						<div class="form-group<?php if (array_key_exists("exampleDescription",$errors)) echo ' has-error ';?>">
							...
							<span id="exampleHelpBlock" class="help-block"><?php bank106_form_response_writing_area_prompt();?> <strong><span id="wCount">0</span></strong> words used of <strong><?php echo bank106_option('exlen')?></strong> word limit</span>		
